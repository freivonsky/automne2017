...
* Exemples:
**/
var arrChiffres = [5, 4, 3, 2, 1];
var spliceDeSuppression = arrChiffres.splice(3, 2);
console.log('Retour du spliceDeSuppression : ' + spliceDeSuppression);
console.log('arrChiffres après splice(3,2): ' + arrChiffres);
var spliceDAjout = arrChiffres.splice(3, 0, 2, 1);
...
/* Tri croissant */
var donneesJeuParPointageCroissant = donneesJeu.joueurs.sort(function (a, b) {
    return a.pointage - b.pointage;
});
console.table(donneesJeuParPointageCroissant);
/* Tri décroissant */
var donneesJeuParPointageDecroissant = donneesJeu.joueurs.sort(function (a, b) {
 ...
 **/
var a = ['Air', 'Eau', 'Feu'];
var jointure = a.join(); // 'Air,Eau,Feu'
console.log("Jointure: " + jointure);
var jointureAvecSeparateur = a.join('-'); // 'Air-Eau-Feu'
 ...
 **/
var trancheArrayChiffres = arrChiffres.slice(2, 5);
console.log('arrChiffres: ' + arrChiffres); //
...
**/
var arrChiffres_sousEnsemble = arrChiffres.filter(function (chiffre) {
    return chiffre < 3;
});
 ...
 */
var arrChiffres_gonflesParMap = arrChiffres.map(function (chiffre) {
...
var lesParagraphesCool = document.querySelectorAll(".cool");
// Notez qu'une NodeList n'est pas un Array
// Si on veut s'en servir comme tel, il faut faire une conversion
var arrParagraphesCool = Array.apply(null, lesParagraphesCool);
...
var somme = arrChiffres.reduce(function (a, b) {
    return a + b;
}, 0);
console.log("Somme par réduction : " + somme);
/* on débute avec a = 1,
 * pour multiplier tout les éléments du tableau */
var produit = arrChiffres.reduce(function (a, b) {
    return a * b;
}, 1);
 ...
 * condition ? oui : non
 **/
var chiffreLePlusGrand = arrChiffres.reduce(function (a, b) {
    return (a > b) ? a : b;
});
 ...
 **/
var repasSemaine1 = ["Salade verte", "Ommelette", "Club Sandwich", "Salade verte", "Club Sandwich", "Salade verte", "Mac&Cheese", "Salade verte", "Boeuf Stroganoff", "Salade verte", "Spaghetti", "Salade verte", "Gratin de légumes", "Ommelette"];
var objRepasSemaine1Compilation = repasSemaine1.reduce(function (obj, item) {
    if (!obj[item]) {
        obj[item] = 0; // l'ajouter avec un indice 0
    }
    obj[item]++; // incrémenter l'indice de ce menu dans l'objet
    return obj;
}, {});
