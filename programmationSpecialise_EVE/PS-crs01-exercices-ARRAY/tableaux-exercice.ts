...
const inventeurs_XVIe = inventeurs.filter( function(inventeur){
...
const inventeursParNomComplet = inventeurs.map( function(inventeur){
...
const inventeursParDateNaissance = inventeurs.sort(function (a, b){
...
const inventeurLongueVie = inventeurs.reduce( function(a ,b) {
...
const moyensDeTransport = ['voiture', 'voiture', 'autobus', 'autobus', 'vélo', 'marche', 'voiture', 'triporteur', 'vélo', 'marche', 'voiture', 'triporteur', 'voiture', 'autobus', 'planche à roulettes'];
