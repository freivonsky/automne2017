 ...
 * @version 1.2.3
 *
 * @todo Documenter la structure du module menu par l'arborescence html (syntaxe de Emmet)
 * STRUCTURE HTML ATTENDU
 * nav.menu.menu--ferme
 ***menu__
 *****
 *
...
//*******************
// TRANSFÉRÉ DANS SCRIPT PRINCIPAL APP.JS
// Pendant la phase de développement ce script est dans le html